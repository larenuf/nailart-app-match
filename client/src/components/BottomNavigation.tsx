  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white shadow-lg px-2 py-2 border-t border-gray-200 z-10">
      <div className="flex justify-between max-w-md mx-auto">
        <div className={`flex flex-col items-center px-3 py-1 ${location === '/' ? 'text-[#D6C3E5]' : 'text-gray-500'}`}>
          <Link href="/">
            <i className="fas fa-home text-lg"></i>
            <span className="text-xs mt-1 block">Ana Sayfa</span>
          </Link>
        </div>
        <div className={`flex flex-col items-center px-3 py-1 ${location === '/search' ? 'text-[#D6C3E5]' : 'text-gray-500'}`}>
          <Link href="/search">
        ...
        <div className={`flex flex-col items-center px-3 py-1 ${location === '/wallet' ? 'text-[#D6C3E5]' : 'text-gray-500'}`}>
          <Link href="/wallet">
            <i className="fas fa-wallet text-lg"></i>
            <span className="text-xs mt-1 block">Cüzdan</span>
          </Link>
        </div>
        <div className={`flex flex-col items-center px-3 py-1 ${location === '/profile' ? 'text-[#D6C3E5]' : 'text-gray-500'}`}>
          <Link href="/profile">
